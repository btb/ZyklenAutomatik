...
#define encoder_PinA 7 //17
#define encoder_PinB 8 //18
...
#define right 11 // 50
#define left A0 // 48
#define encoder 10 // 40

#define led2  13//53 // load/save data
#define led1  13//52 // mode 0/1
#define led3  13//30 // spindleZ activity
#define led4  13//31 // stepper running
//#define out3  8 //unused
...
struct GLOBAL_FLAGS status = {FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE};
